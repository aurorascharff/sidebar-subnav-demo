...
## Problem 1: Section Clicks Can Remount The Sidebar
...
## Problem 2: Request Pathname Reads Make The Shell Less Cacheable
...
## Fix 2: Keep Sidebar Work Cacheable

The layout receives params from the route tree. Sidebar shell work lives in
`features/navigation/navigation-queries.ts`, uses `"use cache"`, and includes a
small fake delay with `await new Promise(...)`.
